...
const newsFeedProducts = async (userFavCategories, category, combinedPosts,limit=10, brands = [], lastDoc = null) => {
...
router.get("/:userId", async (req, res) => {
    try {
        ...
        if (followedBrands.length > 0) {
            const result = await newsFeedProducts(userFavCategories, category, combinedPosts,30, followedBrands, nextLastDoc);
...
module.exports = { router, newsFeedProducts };
